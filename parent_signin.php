...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $confirm_password) {
        ...
        $query = "INSERT INTO parents (username, email, password) VALUES (:username, :email, :password)";
        $stmt = $pdo->prepare($query);

        try {
            $stmt->execute(['username' => $username, 'email' => $email, 'password' => $hashed_password]);
            header('Location: parent_login.php'); // Redirect to login page after successful sign-in
            exit();
...
<head>
    ...
    <link rel="stylesheet" href="parsign.css">
</head>
<body>
<header>
...
<main>
    ...
    <?php endif; ?>
    <form action="parent_signin.php" method="POST">
    ...
    <p>Already have an account? <a href="parent_login.php">Login</a></p>
</main>
</body>
</html>
